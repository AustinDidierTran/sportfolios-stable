...
export default function PrivacyPolicy () {
  ...
  const buttons = [
    {href:privacyPolicy, name :t('privacy_policy'), color:'primary', onClick:() => {}},
    {href:termsConditions, color:'primary', name:t('terms_and_conditions'), onClick:() => {}}
    
  ];
return( 
<MessageAndButtons message={message} buttons={buttons}></MessageAndButtons>);
    }  