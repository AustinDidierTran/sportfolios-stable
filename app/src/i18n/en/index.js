...
export default {
  translations: {
    ...
    import_members_confirmation: "An email will be sent to all your members'. They will be automatically a member of your organization. Do you want to complete the transfer with the file {{fileName}}?",
