...
export default {
  translations: {
    ...
    choose_person_you_can_choose_more_than_one_person: "Choisir la personne. Vous pouvez choisir plus d'une personne si vous le souhaitez.",
    ...
    import_members_confirmation: 'Un courriel va être envoyé à {{membersAmount}} membres. Ils vont recevoir un code coupon à usage unique pour devenir {{membershipName}} de votre organisation. Voulez vous compléter le transfert?',
    ...
    invalid_roster_role_to_submit_score: 'Vous devez être entraîneur, capitaine ou assistant capitaine pour pouvoir soumettre un résultat',
    ...
    other_team_submitted_a_score_description: "Notification reçue lorsqu'une équipe adverse soumet un score pour une partie dont vous n'avez pas encore soumis le votre",
    ...
    team_player_role_error: "Il doit en tout temps y avoir au moins un entraîneur, capitaine ou assistant capitaine dans l'équipe.",
    ...
    you_are_not_in_any_of_these_teans: "Vous ne pouvez pas soumettre un résultat puisque vous n'êtes pas dans aucune des équipes",
    ...
    you_can_go_to_your_organization_settings_to_add_one: 'Vous pouvez aller dans les paramètres de votre organisation pour en ajouter une',
    ...
    you_still_have_x_members_with_incorrect_information: 'Vous avez {{incorrectMembers}} membres avec une information invalide (couriel invalide ou date invalide).',
