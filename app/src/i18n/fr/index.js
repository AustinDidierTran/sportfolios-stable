...
export default {
  translations: {
    ...
    import_members_confirmation: 'Un courriel va être envoyé à tous vos membres. Ils vont être membre de votre organisation automatiquement. Voulez vous compléter le transfert avec le fichier {{fileName}} ?',
