...
export default {
  translations: {
    ...
    import_members_confirmation: 'Un courriel va être envoyé à {{membersAmount}} membres. Ils vont être membre de votre organisation automatiquement. Voulez vous compléter le transfert?',
    import_your_excel_sheet_with_all_your_members: 'Importez le fichier excel avec tout vos membres',
    inclusive: 'Inclus',
    ...
    you_still_have_x_members_with_incorrect_information: 'Vous avez {{incorrectMembers}} avec une information invalide (couriel invalide ou date invalide).',
