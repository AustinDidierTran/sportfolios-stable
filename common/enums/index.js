...
const CHATBOT_STATES = {
  HOME: 0,
  SCORE_SUBMISSION_REQUEST_SENT: 1,
  AWAITING_SCORE_SUBMISSION: 2,
  AWAITING_SCORE_SUBMISSION_CONFIRMATION: 3,
  SPIRIT_SUBMISSION_REQUEST_SENT: 4,
  AWAITING_SPIRIT_RULES: 5,
  AWAITING_SPIRIT_FOULS: 6,
  AWAITING_SPIRIT_EQUITY: 7,
  AWAITING_SPIRIT_SELF_CONTROL: 8,
  AWAITING_SPIRIT_COMMUNICATION: 9,
  AWAITING_SPIRIT_CONFIRMATION: 10,
};
